...
async def test_pii_input():
    ...
    chat = TestChat(
        ...
        llm_completions=[
            "  ask pii question",
            "My name is Bob and my email is bob@gmail.com. Im from Toronto and I love rock music. My SIN number 76543235 was stolen by Tom Smith. In other words, Mr. Smith stole Bob's identity. Mr. Dylan's checking account is 5432123, and his username is dylan123",
            "PII redacted text: My name is [PERSON NAME] and my email is [EMAIL ADDRESS]. Im from [LOCATION] and I love rock music. My SIN number [SOCIAL SECURITY NUMBER] was stolen by [PERSON NAME]. In other words, [PERSON NAME] stole [PERSON NAME]'s identity. [PERSON NAME]'s checking account is [BANK ACCOUNT NUMBER], and his username is [USERNAME]",
        ],
    )
