...
class TestJailbreakCheck(TestCase):
    logger = None
    chatter = None
    ...
    def setUpClass(cls) -> None:
        ...
        cls.logger = create_logger('jailbreak_check.log')
        cls.chatter = create_chatter("jailbreak_check", "jailbreak_check/sample_rails", cls.logger)
    ...
    def test_jailbreak_check(self):
        ...
        self.logger.info("Running test_jailbreak_check...")
