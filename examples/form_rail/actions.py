...
async def form_filling(file_name: Optional[str] = None, context: Optional[dict] = None):
    ...
    print(Back.RED + Fore.BLUE + "====================== Welcome to form filling =========================")
    ...
    if '@' not in email_entered :
        print(Fore.YELLOW +"Entered email : {} is not valid , your email should be in this format maildecoration@domain.countrycode ".format(email_entered))
