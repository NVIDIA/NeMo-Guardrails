...
def fetch_time_precision(query):
    ...
    if wday == "Friday" and ("next day" in query or "tomorrow" in query):
        additional_inserts = (
            "It's {} {}.{}, {}, tomorrow is {}.The time now is {} CET ".format(
                m, day, yr, wday, "weekend", current_time
            )
        )
    else:
        additional_inserts = "It's {} {}.{}, {}.The current time is {} CET".format(
            m, day, yr, wday, current_time
        )
