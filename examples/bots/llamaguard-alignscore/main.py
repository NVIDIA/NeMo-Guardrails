...
llamaguard = RunnableRails(config, input_key="question", output_key="answer", passthrough=False)
...
print(f'Hello, I am an AI Assistant that can answer any questions on NVIDIA AI Enterprise.')
